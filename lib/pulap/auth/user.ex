defmodule Pulap.Auth.User do
  ...
  schema "users" do
    ...
    # Roles
    has_many(:user_roles, Pulap.Auth.UserRole, on_delete: :nothing)
    many_to_many(:roles, Pulap.Auth.Role, join_through: Pulap.Auth.UserRole, on_delete: :nothing)
    # # Profile
    ...
    case changeset do
      %Ecto.Changeset{
        ...
        changes: %{
          ...
          given_password: _given_password
        }
      } ->
        changeset
        |> verify_user(user)
