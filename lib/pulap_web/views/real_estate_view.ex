defmodule PulapWeb.RealEstateView do
  ...
  def render("real_estate.json", %{real_estate: real_estate}) do
    %{id: real_estate.id,
      ...
      property_type_val_end: real_estate.property_type_val_end,
      ...
      type_of_building_val_en: real_estate.type_of_building_val_en,
      type_of_building_val_loc: real_estate.type_of_building_val_loc,
