defmodule PulapWeb.KeyValueControllerTest do
  ...
  @create_attrs %{id: "7488a646-e31f-11e4-aace-600308960662", is_active: true, is_logical_deleted: true, key: "some key", key_group: "some key_group", key_subgroup: "some key_subgroup", locale: "some locale", position: 42, set: "some set", value: "some value"}
