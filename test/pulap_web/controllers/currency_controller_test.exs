defmodule PulapWeb.CurrencyControllerTest do
  ...
  @create_attrs %{code: "some code", icon: "some icon", id: "7488a646-e31f-11e4-aace-600308960662", is_active: true, is_logical_deleted: true, minor_unit: "some minor_unit", name: "some name", num_code: "some num_code"}
