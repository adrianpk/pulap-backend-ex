defmodule PulapWeb.ProfileControllerTest do
  ...
  describe "index" do
    test "lists all profiles", %{conn: conn} do
      conn = get conn, user_profile_path(conn, "7488a646-e31f-11e4-aace-600308960662", :index)
  ...
  describe "create profile" do
    test "renders profile when data is valid", %{conn: conn} do
      conn = post conn, user_profile_path(conn, "7488a646-e31f-11e4-aace-600308960662", :create), profile: @create_attrs
      assert %{"id" => id} = json_response(conn, 201)["data"]

      conn = get conn, user_profile_path(conn, "7488a646-e31f-11e4-aace-600308960662", :show, id)
      assert json_response(conn, 200)["data"] == %{
        # "id" => id,
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn = post conn, user_profile_path(conn, "7488a646-e31f-11e4-aace-600308960662", :create), profile: @invalid_attrs
  ...
  describe "update profile" do
    ...
    test "renders profile when data is valid", %{conn: conn, profile: %Profile{id: id} = profile} do
      conn = put conn, user_profile_path(conn, :update, "7488a646-e31f-11e4-aace-600308960662", profile), profile: @update_attrs
      assert %{"id" => ^id} = json_response(conn, 200)["data"]

      conn = get conn, user_profile_path(conn, :show, "7488a646-e31f-11e4-aace-600308960662", id)
      assert json_response(conn, 200)["data"] == %{
        # "id" => id,
    ...
    test "renders errors when data is invalid", %{conn: conn, profile: profile} do
      conn = put conn, user_profile_path(conn, :update, "7488a646-e31f-11e4-aace-600308960662", profile), profile: @invalid_attrs
      assert json_response(conn, 422)["errors"] != %{}
    end
  end
  ...
  describe "delete profile" do
    ...
    test "deletes chosen profile", %{conn: conn, profile: profile} do
      conn = delete conn, user_profile_path(conn, :delete, "7488a646-e31f-11e4-aace-600308960662", profile)
      assert response(conn, 204)
      assert_error_sent 404, fn ->
        get conn, user_profile_path(conn, :show, "7488a646-e31f-11e4-aace-600308960662", profile)
      end
    end
  end
