defmodule PulapWeb.RealEstateControllerTest do
  ...
  @create_attrs %{
    ...
    currency_code: "cur",
    currency_symbol: "cur",
    building_type_val_en: "type_of_build...",
    building_type_val_loc: "type_of_build...",
  ...
  @update_attrs %{
    ...
    currency_code: "upd",
    currency_symbol: "upd",
    building_type_val_en: "updated type...",
    building_type_val_loc: "updated type_...",
  ...
  describe "create real_estate" do
    test "renders real_estate when data is valid", %{conn: conn} do
      ...
      assert json_response(conn, 200)["data"] == %{
               ...
               "building_type_val_en" => @create_attrs.building_type_val_en,
               ...
               "building_type_val_loc" => @create_attrs.building_type_val_loc,
  ...
  describe "update real_estate" do
    ...
    test "renders real_estate when data is valid", %{
      ...
      assert json_response(conn, 200)["data"] == %{
               ...
               "building_type_val_en" => @update_attrs.building_type_val_en,
               ...
               "building_type_val_loc" => @update_attrs.building_type_val_loc,
