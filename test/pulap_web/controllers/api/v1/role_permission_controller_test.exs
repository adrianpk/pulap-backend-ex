defmodule PulapWeb.RolePermissionControllerTest do
  ...
  describe "create role_permission" do
    test "renders role_permission when data is valid", %{conn: conn} do
      conn =
        post(conn, api_v1_role_permission_path(conn, :create), role_permission: @create_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn =
        post(conn, api_v1_role_permission_path(conn, :create), role_permission: @invalid_attrs)
  ...
  describe "update role_permission" do
    ...
    test "renders role_permission when data is valid", %{
      ...
      conn =
        put(
          conn,
          api_v1_role_permission_path(conn, :update, role_permission),
