defmodule PulapWeb.PropertySetControllerTest do
  ...
  describe "update property_set" do
    ...
    test "renders property_set when data is valid", %{
      conn: conn,
      property_set: %PropertySet{id: id} = property_set
    } do
      conn =
        put(
          conn,
          api_v1_property_set_path(conn, :update, property_set),
          property_set: @update_attrs
        )
