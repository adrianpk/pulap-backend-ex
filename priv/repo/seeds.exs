...
# Enterprise Owner
data                  = %{name: "enterprise-owner", description: "Enterprise Owner", description: "Enterprise onwer.", active: true, is_logical_deleted: false}
changeset             = Role.changeset(%Role{}, data)
enterprise_owner_role = Repo.insert! changeset

# Enterprise Admin
data                  = %{name: "enterprise-admin", description: "Enterprise admin", activeive: true, is_logical_deleted: false}
changeset             = Role.changeset(%Role{}, data)
enterprise_admin_role = Repo.insert! changeset

# Enterprise Manager
data                    = %{name: "enterprise-manager", description: "Enterprise manager", active: true, is_logical_deleted: false}
changeset               = Role.changeset(%Role{}, data)
enterprise_manager_role = Repo.insert! changeset

# Agency Owner
data              = %{name: "agency-owner", description: "Agency Owner", description: "Agency onwer", active: true, is_logical_deleted: false}
changeset         = Role.changeset(%Role{}, data)
agency_owner_role = Repo.insert! changeset

# Agency Admin
data              = %{name: "agency-admin", description: "Agency admin.", activeive: true, is_logical_deleted: false}
changeset         = Role.changeset(%Role{}, data)
agency_admin_role = Repo.insert! changeset

# Agency Manager
data       = %{name: "agency-manager", description: "Agency manager.", active: true, is_logical_deleted: false}
changeset  = Role.changeset(%Role{}, data)
admin_role = Repo.insert! changeset

# PrivateOfferer
data                 = %{name: "private-offerer", description: "Private offerer.", active: true, is_logical_deleted: false}
changeset            = Role.changeset(%Role{}, data)
...
# UserRoles --------------------------------------------------------------------------------------------------------------
## Superadmin
data                 = %{organization_id: pulap_organization.id, user_id: superadmin_user.id, role_id: superadmin_role.id, active: true, is_logical_deleted: false}
...
data                      = %{organization_id: pulap_organization.id, user_id: superadmin_user.id, real_estate_id: real_estate_one.id, active: true, is_logical_deleted: false}
Logger.debug("Data: " <> inspect(data))
changeset                 = Ownership.changeset(%Ownership{}, data)
real_estate_one_ownership = Repo.insert! changeset

## Real Estate Two Ownership
data                       = %{user_id: superadmin_user.id, real_estate_id: real_estate_two.id, active: true, is_logical_deleted: false}
changeset                  = Ownership.changeset(%Ownership{}, data)
real_estate_twio_ownership = Repo.insert! changeset
